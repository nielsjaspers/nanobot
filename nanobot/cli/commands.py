...
def onboard():
    ...
    console.print("     Set [cyan]providers.custom.apiBase[/cyan] to https://opencode.ai/zen/go/v1")
    console.print("     and add your OpenCode Go API key to [cyan]providers.custom.apiKey[/cyan]")
    console.print('  2. Chat: [cyan]nanobot agent -m "Hello!"[/cyan]')
    console.print("\n[dim]Telegram is the recommended channel for this fork.[/dim]")
...
def gateway(
    ...
    if config.gateway.opencode.enabled:
        console.print(
            f"[green]✓[/green] OpenCode Serve: {config.gateway.opencode.url} "
            f"({config.gateway.opencode.model_provider_id}/{config.gateway.opencode.model_id})"
        )
